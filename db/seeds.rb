...
Question.create(description: "Which of the following tokens was not one of the ten original game pieces in Monopoly?", answer: "Dog", category_id: boardGames.id) 
        Question.create(description: "Who is the unfortunate victim in the game Clue?", answer: "Mr.Boddy", category_id: boardGames.id) 
...
Question.create(description: "What was the name of the boat in Jaws?", answer: "Orca", category_id: movies.id) 
Question.create(description: "What animal was framed in the unfinished paint-by-number in Rizzo’s room in Grease?", answer: "A horse", category_id: movies.id) 
